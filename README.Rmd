...
```{r waic_plot, include=FALSE, eval=TRUE}
...
From this table, we see that the six parameter model provides a better relative fit to the data (**WAIC = 4281**) than the five parameter alternative (**WAIC = 5063**), despite the greater complexity.
