...
may also recognize it as the same function used as the activation for
the output layer of a neural net binary classifier. Logistic curves are
commonly applied to model the growth trajectories of plants and animals.
...
![](README_files/figure-gfm/logistic5_fit-1.png)<!-- -->
...
with an extra parameter \(\theta_6\) that allows for a second asymptote
